...
to test-rep
  ask agvs [set xcor 19 set ycor 0 set heading 0 set status "replenishment" set path-status "on-the-way"]
end
...
to virtual-replenish [id]
  ...
  set destination [empty-id] of one-of emptys with [status != 1 and ycor <= 26]
  let n destination
