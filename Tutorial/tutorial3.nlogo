...
to move-turtles
  ...
  ask turtles [
    ...
    if ticks mod 500 = 0 [
      set energy random 10 + 10
      if random 100 <= 15 [die]
...
to regrow-grass
  ask patches [ ;; 3 out of 100 times, the patch color is set to green
    ...
    if ticks mod 500 = 0 [ set pcolor green ]
  ]
end
@#$#@#$#@
GRAPHICS-WINDOW
...
"" ""
PENS
"totalEnergy" 1.0 0 -16777216 true "" "if ticks mod 500 = 0 [ ask turtles [ plot energy ] ]"
